...
<div class="container pt-5">
					...
					<div class="row py-4 mb-2">
						<div class="col-md-7 order-2">
							...
							<p class="lead appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700"> {{$data->short_description}} </p>
							<p class="pb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800"> {{$data->short_description}}  </p>
